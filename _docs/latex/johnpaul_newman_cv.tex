...
\summary{Skilled Windows and Linux DevOps Engineer, with 5+ years hands-on experience working in an Agile environment for a FinTech PCI-DSS compliant business. \\
...
\twentyitem
	...
	{\begin{itemize}
		\item Implementation and maintenance of AWS infrastructure, including 200+ EC2 instances with Active Directory servers
...
\twentyitem
    ...
    {\begin{itemize}
		...
		\item Set-up and maintained Sage Line 100, an MS-DOS based accounting system
	 \end{itemize}
    }
\end{twenty}
