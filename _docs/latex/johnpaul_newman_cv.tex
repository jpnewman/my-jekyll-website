...
\iac{{Packer $\textbullet$ Terraform / 5}, {Ansible $\textbullet$ Chef / 5}}

\oses{{Linux (Ubuntu) $\textbullet$ Mac OS X / 5}, {Windows / 5.5}}

\platforms{{Xbox 360 $\textbullet$ PS3 / 3}, {iOS $\textbullet$ Android / 4}, { Docker $\textbullet$ Kubernetes / 3}, {VMware / 4.5}, {AWS / 5}}
