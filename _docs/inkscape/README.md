...
/Applications/Inkscape.app/Contents/MacOS/inkscape $(PWD)/WorkExperience_Divido.svg --export-filename=$(PWD)/../latex/WorkExperience_Divido.pdf --export-type="pdf" --export-text-to-path --export-dpi 300
