...
- Maintained CI servers, like Artifactory, Gerrit, and Jenkins.
...
### Software Internationalization Engineer II (Ireland)
...
## Welocalize / Connect Global Solutions : 2002 — 2007

### Software Internationalization and Build Engineer (Ireland)
...
- Developed a process to extract text from the Palm OS RSRC file format, enabling shorter localization cycles
...
## Bowne Global Solutions : 2000 — 2002

### Software Localization Engineer (Ireland)
...
## Tek Translation : 1998 — 2000

### Software Localization Engineer & IT Network Administrator (Ireland / England)
...
## Aylwin Girl's School : 1996 — 1997

### IT Network Administrator & Laboratory Technician (England)

#### Responsibilities:
- Maintenance of 250 workstations and Novell servers
1995

## Guy's Hospital X-Ray Department
- Support Technician — Student Placement (England)
...
- OpsCode Chef
- AWS Couldformation
- HasiCorp products (Vagrant, Terraform, Packer)
...
- PowerShell (with DSC and Pester)
- Ruby
- Python
- C, C++ (with MFC, ATL, and COM)
- Objective-C
- C# (with ASP.Net)
- GNU, nmake makefiles, and Bash Shell Script
...
- Photography
- Electronics
- Infographies and Data visualization
