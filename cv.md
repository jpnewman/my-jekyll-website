...
||||
|---|---|---|
|**Provisioning Tools**|**CI/CD Tools**|**Monitoring Tools/Logging Tools/Alerting**|
|- OpsCode Chef<br />- AWS Cloud​Formation<br />- Ansible, HasiCorp Terraform and Packer|- Jenkins<br />- Artifactory<br />- Octopus Deploy|- New Relic<br /><br />- Splunk<br />- ELK/Elastic stack|
...
|- JIRA<br /><br />- Confluence<br />- SharePoint|- NServiceBus<br />- Entity Framework<br />- Docker|- PowerShell (DSC and Pester)<br />- Ruby<br />- Python<br />- C, C++ (MFC, ATL, and COM)<br />- Objective-C<br />- C# (ASP.Net and Core)<br />- Bash Shell Script|
...
- Developed a RESTful Reporting Service using C#, Entity Framework (EF), with the Repository Pattern, JQuery and a d3.js frontend.
